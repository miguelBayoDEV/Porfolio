...
public class OperacionesScanner {
	...
	public static LocalDate leerFechaPublicacion() {
		LocalDate fechaPublicacion = LocalDate.now();
		try {
			int day = OperacionesScanner.leerNumeroEnteroInt("Introduzca día publicación:");
			int month = OperacionesScanner.leerNumeroEnteroInt("Introduzca mes publicación:");
			int year = OperacionesScanner.leerNumeroEnteroInt("Introduzca año publicación:");
	...
	public static LocalTime leerDuracion() {
		LocalTime duracion = LocalTime.now();
		try {
			int hour = OperacionesScanner.leerNumeroEnteroInt("Introduzca horas:");
			int minutes = OperacionesScanner.leerNumeroEnteroInt("Introduzca minutos:");
			int seconds = OperacionesScanner.leerNumeroEnteroInt("Introduzca segundos:");
			duracion = LocalTime.of(hour, minutes, seconds);
		}catch(Exception e) {
			System.out.println("Error al introducir otro tipo de dato que no es numérico." + e.getMessage());
		}
		return duracion;
