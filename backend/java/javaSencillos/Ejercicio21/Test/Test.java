...
import CuotasClub_Ejer18.Club;
import CuotasClub_Ejer18.Socio;
import DevolverMonedas_Ejer20.Dinero;
...
import Factorial_Ejer17.OperacionNumero;
import HolaMundo_Ejer01.HolaMundo;
import Limites_Ejer21.OperacionesRangoNumeros;
import LoteriaPromitiva_Ejer16.Apuesta;
import LoteriaPromitiva_Ejer16.SimuladorLoteriaPrimitiva;
...
import TrianguloAsterisco_Ejer19.TrianguloAsterisco;
...
public class Test {
	...
	public static void test16() {
		...
		System.out.println("Apuesta: " + apuesta.imprimirApuesta());
		
		// Automático
		SimuladorLoteriaPrimitiva.rellenarApuestasLoteria();
		SimuladorLoteriaPrimitiva.rellenarApuestasLoteriaDeseados();
		SimuladorLoteriaPrimitiva.rellenarApuestasLoteriaDeseados(7);
	}
	
	public static void test17() {
		OperacionNumero.factorial(5);
		OperacionNumero.factorial(3);
		OperacionNumero.factorial(7);
	}
	
	public static void test18() {
		Socio cliente1 = new Socio("Miguel", "Bayo", "87650349L", "+34 654654765", 23, false, false);
		Socio cliente2 = new Socio("Jesus", "Lomb", "87650469L", "+34 654654764", 70, false, false);
		Socio cliente3 = new Socio("Ana", "Fronc", "87657349L", "+34 654654763", 30, true, true);
		Socio cliente4 = new Socio("Juan", "Somb", "87658749L", "+34 654654766", 15, false, false);
		Socio cliente5 = new Socio("Ismael", "Imvd", "87690349L", "+34 654654755", 12, false, true);
		Club.crearCliente(cliente1);
		Club.crearCliente(cliente2);
		Club.crearCliente(cliente3);
		Club.crearCliente(cliente4);
		Club.crearCliente(cliente5);
		System.out.println(Club.calcularCuota());
	}
	
	public static void test19() {
		TrianguloAsterisco.crearTrianguloAsteriscosA(OperacionesScanner.leerNumeroEnteroInt("Introduzca número del 1 al 10:"));
		TrianguloAsterisco.crearTrianguloAsteriscosB(OperacionesScanner.leerNumeroEnteroInt("Introduzca número del 1 al 10:"));
		TrianguloAsterisco.crearTrianguloAsteriscosC(OperacionesScanner.leerNumeroEnteroInt("Introduzca número del 1 al 10:"));
	}
	
	public static void test20() {
		System.out.println(Dinero.fragmentarDinero(2.12));
		System.out.println(Dinero.fragmentarDinero(25.87));
		System.out.println(Dinero.fragmentarDinero(3.88));
	}
	
	public static void test21() {
		OperacionesRangoNumeros.cuboNumeroDentroRango(1, 10, 3);
		OperacionesRangoNumeros.cuboNumeroDentroRango(50, 100, 7);
	}
}
