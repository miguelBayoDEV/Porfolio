...
public class Ejercicio32 {
	public static void main(String[] args){
		...
		boolean resultado1 = (notaMedia>7)&&(15>=númeroFaltas)&&(númeroFaltas<=20);
		boolean resultado2 = (notaMedia<5)&&(númeroFaltas>20);
		boolean resultadoTotal = resultado||resultado1||resultado2;
